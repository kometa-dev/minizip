...
#------------------------------------------------------------------
  ...
  if(ZLIB_FOUND AND NOT "${ZLIB_INCLUDE_DIR}" STREQUAL "${CMAKE_INSTALL_PREFIX}/include")
    ...
    set(${MY_PROJECT_NAME}_ZLIB_LIBRARY_RELEASE ${${MY_PROJECT_NAME}_ZLIB_LIBRARY_DIR}/zlibstatic.lib)
    set(${MY_PROJECT_NAME}_ZLIB_LIBRARY_DEBUG ${${MY_PROJECT_NAME}_ZLIB_LIBRARY_DIR}/zlibstaticd.lib)
